...
public class ControlleurSimulation {
	...
	private void initialize() {
		...
		canvas_simulation.addEventHandler(MouseEvent.MOUSE_CLICKED,
            ...
            public void handle(MouseEvent t) {
            	...
            	//TODO: gÈrer le dÈpop des fenÍtres...
	...
	public void reagir_action_bouton_ralentir() {
		afficher_fenetre_modale_d_erreur("La fonctionnalit√© 'Ralentir la simulation' n'est pas impl√©ment√©e.");	
	}
	
	public void reagir_action_bouton_accelerer() {
		afficher_fenetre_modale_d_erreur("La fonctionnalit√© 'Acc√©lerer la simulation' n'est pas impl√©ment√©e.");	
	}
